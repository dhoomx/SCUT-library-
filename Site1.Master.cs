...
namespace WebApplication1
{
    public partial class Site1 : System.Web.UI.MasterPage
    {
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            try
            {
                if (Session["role"] == null)
                {
                    ...
                    LinkButton7.Visible = false; // Hello "user name" link btn
                ...
                else if (Session["role"].Equals("user"))
                {
                    ...
                    LinkButton7.Visible = true; // Hello "user name" link btn
                    LinkButton7.Text = "Hello" + Session["username"].ToString(); // Hello "user name" link btn
        ...
        {
            Response.Redirect("adminAuther.aspx");
        }

        protected void LinkButton12_Click(object sender, EventArgs e)
        {
            Response.Redirect("adminpubliser.aspx");
        }
